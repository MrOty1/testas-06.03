...
let movieImages = [
    "https://m.media-amazon.com/images/M/MV5BNzFkMDE2ZmEtOWMwNy00MWM2LThlNjMtZWQzNWY5MTJjZjcxXkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMzc3MWVlMDctZTRjZi00YmZiLTg2OGItMGNkYWQwYjYwNjE1XkEyXkFqcGc@._V1_FMjpg_UX1017_.jpg",
    ...
    "https://m.media-amazon.com/images/M/MV5BMTk3OTEyNjk1M15BMl5BanBnXkFtZTcwNTgwMTI2MQ@@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMTYwNDQyOTE0NF5BMl5BanBnXkFtZTYwNzQ0MTI3._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMWVhMjk4NTctYjYyYS00NjYxLWE5NTgtNTIzMTgzZDQyNzIyXkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMTg2OTcyNzEwN15BMl5BanBnXkFtZTgwOTU0Mzc5NTE@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMTA0NDY2MzQxODheQTJeQWpwZ15BbWU3MDU3OTcwNjc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMDlkZTNjMWMtNmVhYy00N2RiLTg1MWYtNjY4ZDdiOGJjN2VhXkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMjAwMjQ1ODA0NV5BMl5BanBnXkFtZTcwMjc4MTc0Mw@@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BNGFmYzA5NzktOTc1Ni00YTIxLWJiZTEtNmEyZjBjNDM2MjRlXkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMzAwNmQzMzAtYjlhMi00ZGMxLWFmM2UtN2VhNDI2OGIyMjg0XkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMTk3Nzk4MzkzMV5BMl5BanBnXkFtZTcwMDU3OTQzMw@@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BYzFjMzNjOTktNDBlNy00YWZhLWExYTctZDcxNDA4OWVhOTJjXkEyXkFqcGc@._V1_.jpg",
    "https://m.media-amazon.com/images/M/MV5BMjE0MzcwMDAyNl5BMl5BanBnXkFtZTgwMzc4ODg0NDM@._V1_.jpg",
    ...
    "../images/movies/poster.png",
    "../images/movies/poster2.png",
    "../images/movies/poster3.png",
    "../images/movies/poster4.png",
    "../images/movies/poster5.png"
];
...
const detectMovie = (title, titleTop, poster, text, criticCMT, fanCMT, pageNumber, movieRatings) => {
    let criticScore = 0;
    let fanScore = 0;
    ...
    for(let i = 0; i < movieRatings.length; i++){
        if(i == `${pageNumber}` - 1){
        text.innerHTML += `
        <p>${movieRatings[i].desc}</p>`;
        poster.innerHTML += `
        <a href="${movieImages[i]}" target="_blank"><img src="${movieImages[i]}"></a>`;
        }
    }
}

addMovieList(movieCompactList, movieReviews);
detectMovie(movieTitle, movieTitleTop, moviePoster, movieText, criticComment, fanComment, currentPage, movieReviews);
